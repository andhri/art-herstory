from tkinter import *
from game_logic_v2 import ArtGame
...
class GameInterface:
    def __init__(self, art_game: ArtGame):
        ...
        # the code above will be removed and merged with Kristina's code for main interface
        ...
        # -----------------------------------------------------------------------------------------------
        # Below will be the code for making the art image titles into buttons that when clicked should...
        # ...trigger the pop-up window with additional information relating to that art piece.

        # draft one - place code here within main logic for now without refactoring - just check that the logic
        # and functionality works (still in progress):
