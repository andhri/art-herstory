...
from score import SaveGameScore
...
class GameInterface:
    ...
    def generate_options(self):
        ...
        if self.game_logic.still_has_lives():
            ...
            # print("?????? this is generate_option_1",self.art_options.display_option_1())
            ...
            # self.art_options.option1id.config(text= self.database[self.left_choice_index]["objectID"])

            # self.art_options.display_option_2()

            # print("!!!!!!!!, this is generate_option_2", self.art_options.display_option_2())
