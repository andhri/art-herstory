...
class SaveGameScore:
    ...
    def __init__(self, game_logic: ArtGame):
        ...
        self.master.iconbitmap("CFG_logo.ico")
        ...
        self.leaderboard_button = Button(self.master, text="Leaderboard", highlightthickness=0, fg=main_config.DEFAULT_FONT_COLOUR,
